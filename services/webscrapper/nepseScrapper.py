...
class NepseScraper:
    ...
    def __init__(self):
        logger.log("retain AI is trying to scrape Nepse data")
        logger.log("opening browser window...", bold=True)
        options = Options()
        ...
        logger.log("Browser Opened", level = "success")
        logger.log("Do not close the browser window", level = "warn")
        ...
        try:
            ...
            for row in rows :
                ...
                if cols:
                    ...
                    data.append(row)
            df = pd.DataFrame(data, columns=header_texts)
            logger.log("Fetching data success", level = "success")
            return df
        except:
            logger.log("Fetching data failed", level = "error")
